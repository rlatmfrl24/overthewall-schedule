...
> 과거 진단 기록: 아래 위치·코드·상태는 점검 당시 기준이다. 후속 구현과 현행 운영은 [정리 적용 계약](retired-implementation-cleanup-before-2026-09-17.md)을 따른다. 종료된 WebSub·warmup 설명을 재활성화 지침으로 사용하지 않는다.
