...
| `operations/x-member-history-and-compliance-design.md` | Canonical forward-only X history, admin analytics, Batch Compliance, rollout, and operational Closeout. |
