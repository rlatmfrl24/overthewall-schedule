...
| 후속 구체화 · NEXT-BROADCAST | 방송 가창 사용자 탭 | 후보/draft 기반을 재사용하고 방송일·원본 방송·setlist·공개 탐색/재생을 구체화. TBD-004/005와 상세 UX·공개 모델 결정 필요 |
...
| TBD-024 | 방송 가창 사용자 탭 상세 | 탭 위치는 사용자용 OTW Play 내부로 확정. 방송 단위 목록/곡 단위 목록, 필터·setlist·원본 없는 가창 및 공개 정책을 후속 구체화 |
