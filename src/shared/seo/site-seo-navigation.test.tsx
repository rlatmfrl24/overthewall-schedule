...
import { buildPlaySongsSiteSeo, buildProfileSiteSeo, type SiteSeoMetadata } from "@contracts/site-seo";
...
describe("SEO navigation", () => {
  it("replaces profile and search metadata on client navigation and clears old images", () => {
    ...
    const play = buildPlaySongsSiteSeo("noindex,nofollow");
    ...
    view.rerender(<SiteSeoProvider pathname="/play/songs"><Page metadata={play} /></SiteSeoProvider>);
    ...
    view.rerender(<SiteSeoProvider pathname="/play/songs"><Page metadata={null} /></SiteSeoProvider>);
