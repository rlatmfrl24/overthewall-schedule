...
export const VodsOverview = () => {
  ...
  const filterMembers =
    activeTab === "youtube" ? membersWithYouTube : membersWithChzzk;
      ...
      <div className="container mx-auto px-4 pt-8 pb-8 space-y-6">
        ...
        <div className="relative inline-grid grid-cols-2 p-1 rounded-xl bg-muted w-fit">
          <div
            ...
            style={{
              transform:
                activeTab === "youtube" ? "translateX(0)" : "translateX(100%)",
            }}
          />
          <button
        ...
        {activeTab === "youtube" ? (
          ...
          <div className="space-y-10">
            ...
            <ChzzkClipsPlaylist
              ...
              members={members}
              loading={
                isChzzkTab && membersWithChzzk.length > 0 && !clipsLoaded
              }
            />
