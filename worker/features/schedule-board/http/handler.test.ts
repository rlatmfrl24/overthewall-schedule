...
import { createHandleScheduleBoard } from "./handler";
...
const reader = {
  read: getScheduleBoardMock,
} as ScheduleBoardReader;
const handleScheduleBoard = createHandleScheduleBoard(() => reader);
