/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 610851438662b05ba20fdf57dce018fc)
// Runtime types generated with workerd@1.20260907.1 2025-11-25
interface __BaseEnv_Env {
	ASSET_BUCKET: R2Bucket;
	otw_db: D1Database;
	OTW_PLAY_ANALYTICS: AnalyticsEngineDataset;
	YOUTUBE_CACHE_ANALYTICS: AnalyticsEngineDataset;
	OTW_PLAY_AI_REVIEW_QUEUE: Queue;
	OTW_OPS_CONTROL_QUEUE: Queue;
	OTW_OPS_CRITICAL_QUEUE: Queue;
	OTW_OPS_BACKGROUND_QUEUE: Queue;
	OTW_PLAY_INGESTION_QUEUE: Queue;
	OTW_PLAY_SUBMISSION_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	CLOUDFLARE_D1_DATABASE_ID: "133b980d-1701-427e-93fd-8c9dcca1132e";
	OTW_PLAY_PUBLIC_ORIGIN: "https://otw-schedule.info";
	OTW_PLAY_AI_REVIEW_ENABLED: "false";
	OTW_PLAY_AI_REVIEW_MODEL: "gemini-3.8-flash";
	OTW_PLAY_AI_REVIEW_DAILY_LIMIT: "100";
	CLERK_ISSUER: string;
	...
	SCHEDULED_OPERATIONS_WORKFLOW: Workflow<Parameters<import("./worker/index").ScheduledOperationsWorkflow['run']>[0]['payload']>;
}
